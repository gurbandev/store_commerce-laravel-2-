            ...
            <div class="col">
                <div class="mb-2">
                    ...
                    @if($product->checkOwner())
                        ...
                        <a href="#" class="link-secondary" data-bs-toggle="modal" data-bs-target="#delete-{{ $product->id }}"><i class="bi-trash-fill"></i></a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ route('products.delete', $product->id) }}" method="post">
                                            ...
                                            <button type="submit" class="btn btn-dark btn-sm"><i class="bi-trash-fill"></i> @lang('app.delete')</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="mb-2">
                    <i class="bi-person-fill"></i> <span class="fw-semibold">{{ $product->user->name }}</span>
                </div>
